...
query=f'''SELECT a.APPTGIVENDT1,a.REGID,a.APPTNO,a.FROMTIME,a.TOTIME,a.DAID,a.TM,(SELECT d.DT FROM OTS1.DOCTORAPPOINTMENTHDR d WHERE d.DAID=a.DAID) AS AppointmentDate  FROM OTS1.DOCTORAPPOINTMENTDTS a WHERE a.APPTGIVENDT1=to_timestamp('{td}', 'YYYY-MM-DD" "HH24:MI:SS')'''
